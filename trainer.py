...
from object_detection.my.utils import variables_helper
...
def _create_losses(create_tensor_dict_fn, create_model_fn, train_config):
  ...
  (images, groundtruth_boxes_list, groundtruth_classes_list,
   groundtruth_masks_list, groundtruth_keypoints_list) = create_tensor_dict_fn()
...
def train(create_tensor_dict_fn, create_model_fn, train_config, master, task,
  ...
  with tf.Graph().as_default():
    ...
    clones = model_deploy.create_clones(deploy_config, model_fn, [create_tensor_dict_fn])
